...
public class PlateformeTest {
    ...
    void testGetPathByModaliteAndTypeCout() {
        Chemin ch = (g.getPathByModaliteAndTypeCout("villeA", "villeD", ModaliteTransport.TRAIN, TypeCout.PRIX, 1))
                .get(0);
        assertEquals(78, ch.poids());

        Chemin ch2 = (g.getPathByModaliteAndTypeCout("villeA", "villeD", ModaliteTransport.TRAIN, TypeCout.TEMPS, 1))
                .get(0);
        assertEquals(120, ch2.poids());

        Chemin ch3 = (g.getPathByModaliteAndTypeCout("villeA", "villeD", ModaliteTransport.TRAIN, TypeCout.CO2, 1))
                .get(0);
        assertEquals(2.5999999999999996, ch3.poids());

        Chemin ch4 = (g.getPathByModaliteAndTypeCout("villeC", "villeD", ModaliteTransport.AVION, TypeCout.TEMPS, 1))
                .get(0);
    ...
    // assertEquals(Plateforme.TEMP_CHANGEMENT * 0,
    // CheminImpl.getCHangementDuration(ch1));
    // assertEquals(Plateforme.TEMP_CHANGEMENT * 1,
    // CheminImpl.getCHangementDuration(ch2));
    // assertEquals(Plateforme.TEMP_CHANGEMENT * 1,
    // CheminImpl.getCHangementDuration(ch3));
    // assertEquals(Plateforme.TEMP_CHANGEMENT * 2,
    // CheminImpl.getCHangementDuration(ch4));
    // assertEquals(Plateforme.TEMP_CHANGEMENT * 0,
    // CheminImpl.getCHangementDuration(ch5));
    // }
